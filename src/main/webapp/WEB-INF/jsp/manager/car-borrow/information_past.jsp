        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-body ">
                    <form class="layui-form layui-col-space5" onsubmit="return check()" action="${pageContext.request.contextPath}/manager/car-borrow/past"  method="post">
                        ...
                        <div class="layui-inline layui-show-xs-block">
                            <input class="layui-input" type="datetime-local" id="pre_time" name="pre_time"  placeholder="出借时间" autocomplete="off" >
                        </div>
                        <div class="layui-inline layui-show-xs-block">
                            <input class="layui-input" type="datetime-local" id="next_time" name="next_time"  placeholder="还车时间" autocomplete="off" >
                        </div>
                        <div class="layui-inline layui-show-xs-block">
